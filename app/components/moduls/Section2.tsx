  ...
  return (
    <div className=" mx-auto ">
      ...
      <ul className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3 ">
        <li className="relative bg-background flex flex-col justify-between border rounded shadow-md hover:shadow-primary-400">
          <Link className="relative" to="/tool/writey-ai">
          ...
          <div className="flex flex-col justify-beetween gap-3 px-4 py-2">
            <p className="text-textt  two-lines">
        ...
        <li className="relative bg-background flex flex-col justify-between border rounded shadow-md hover:shadow-primary-400">
          <Link className="relative" to="/tool/writemeai">
            <div className="relative w-full aspect-video">
              <img
                className="rounded w-full h-full object-cover"
        ...
        <li className="relative bg-background flex flex-col justify-between border rounded shadow-md hover:shadow-primary-400">
          <Link className="relative" to="/tool/publer">
            <div className="relative w-full aspect-video">
              <img
                className="rounded w-full h-full object-cover"
        ...
        <li className="relative bg-background flex flex-col justify-between border rounded shadow-md hover:shadow-primary-400">
          <Link className="relative" to="/tool/anyword">
            <div className="relative w-full aspect-video">
              <img
                className="rounded w-full h-full object-cover"
        ...
        <li className="relative bg-background flex flex-col justify-between border rounded shadow-md hover:shadow-primary-400">
          <Link className="relative" to="/tool/blogseo-ai">
            <div className="relative w-full aspect-video">
              <img
                className="rounded w-full h-full object-cover"
        ...
        <li className="relative bg-background flex flex-col justify-between border rounded shadow-md hover:shadow-primary-400">
          <Link className="relative" to="/tool/typewise">
            <div className="relative w-full aspect-video">
              <img
                className="rounded w-full h-full object-cover"
                src="https://images.unsplash.com/photo-1486312338219-ce68d2c6f44d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NzEyNjZ8MHwxfHNlYXJjaHw4fHxrZXlib2FyZHxlbnwwfDB8fHwxNjk5NTI1MDAzfDA&ixlib=rb-4.0.3&q=80&w=1080"
