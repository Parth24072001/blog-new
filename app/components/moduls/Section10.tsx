const Section10 = () => {
  return (
    <div className=" mx-auto ">
      ...
      <ul className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3 py-2 xl:py-5">
        <li className="relative bg-background flex flex-col justify-between border rounded shadow-md hover:shadow-teal-400">
          ...
          <div className="flex flex-col justify-beetween gap-3 px-4 py-2">
            <a
              href="/tool/writey-ai"
              className="flex justify-center items-center text-xl font-semibold text-primary  hover:text-teal-800 two-lines text-ellipsis"
            >
